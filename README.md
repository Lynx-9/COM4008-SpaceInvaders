This will detail what we need to add to the wiki when we can learn how to write a wiki 

 
Hadrian wrote the code for the invaders, and the invaders will increase their speed with each death
• Requirement: The full invaders array should include the three types of aliens. These should move
